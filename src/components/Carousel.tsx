...
const slides = [
  'shawarma.png',
  'hamburger.png',
  'icons8-pasta-96 (1).png',
  'icons8-fried-rice-64.png',
  'icons8-fried-chicken-64 (1).png',
  'icons8-sandwich-96.png',
  'kids-meal.png',
];
...
const Carousel: React.FC = () => (
  <div className="slide-container">
    {slides.map((slide, index) => (
      <Slider
        key={slide}
        imageSrc={`/images/${slide}`}
        isActive={index === 0}
      />
    ))}
    <span className="material-symbols-outlined" id="prev" data-testid="prev">
      <svg
    ...
    <span className="material-symbols-outlined" id="next" data-testid="next">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        height="48px"
        viewBox="0 -960 960 960"
